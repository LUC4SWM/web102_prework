...
const summary = `A total of $${raised.toLocaleString()} has been raised for ${totalGames} ${
    totalGames === 1 ? "game" : "games"
}, but ${unfundedCount} ${unfundedCount === 1 ? "game remains" : "games remain"} unfunded. We need your help to fund these amazing projects!`;


// create a new DOM element containing the template string and append it to the description container
const dscrptContainer = document.getElementById("description-container");
const summaryParagraph = document.createElement("p");
summaryParagraph.innerText = summary;
dscrptContainer.appendChild(summaryParagraph);
/************************************************************************************
